...
public class OpenByLeftBeforeGameStartedEventConsumer extends SimpleEventsConsumer {
	...
	public void consumerOperations(ConsumerRecord<String,String> record) {
    	try{
    		...
    		gameRoomClosedEvent.setUuid(openByLeftBeforeGameStartedEvent.getUuid());
    		gameRoomClosedEvent.setArrived(new Date());
    		gameRoomClosedEvent.setClazz("GameRoomClosedEvent");
    		gameRoomClosedEvent.setLoggedOutUserName(openByLeftBeforeGameStartedEvent.getLeavingUserName());
    		gameRoomClosedEvent.setGameRoom(openByLeftBeforeGameStartedEvent.getGameRoom());
