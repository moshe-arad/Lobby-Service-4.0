...
public class LoggedOutWatcherLeftLastEventConsumer extends SimpleEventsConsumer {
	...
	public void consumerOperations(ConsumerRecord<String,String> record) {
    	try{
    		...
    		gameRoomClosedEvent.setUuid(loggedOutWatcherLeftLastEvent.getUuid());
    		gameRoomClosedEvent.setArrived(new Date());
    		gameRoomClosedEvent.setClazz("GameRoomClosedEvent");
    		gameRoomClosedEvent.setLoggedOutUserName(loggedOutWatcherLeftLastEvent.getWatcher());
    		gameRoomClosedEvent.setGameRoom(loggedOutWatcherLeftLastEvent.getGameRoom());
