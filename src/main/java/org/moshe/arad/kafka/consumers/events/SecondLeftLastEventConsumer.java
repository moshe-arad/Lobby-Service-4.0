...
public class SecondLeftLastEventConsumer extends SimpleEventsConsumer {
	...
	public void consumerOperations(ConsumerRecord<String,String> record) {
    	try{
    		...
    		gameRoomClosedEvent.setUuid(secondLeftLastEvent.getUuid());
    		gameRoomClosedEvent.setArrived(new Date());
    		gameRoomClosedEvent.setClazz("GameRoomClosedEvent");
    		gameRoomClosedEvent.setLoggedOutUserName(secondLeftLastEvent.getSecond());
    		gameRoomClosedEvent.setGameRoom(secondLeftLastEvent.getGameRoom());
